        ...
        <div className="card2 roundedd">
          <div className="h-100 d-flex flex-column justify-content-between">
            <div className="upper ms-3">
              <table>
                <tbody>
                  <tr>
                    <td>Min Temp</td>
                    <td>{Math.round(weather.list[0].main.temp_min)}&#8451;</td>
                  </tr>

                  <tr>
                    <td>Max Temp</td>
                    <td>{Math.round(weather.list[0].main.temp_max)}&#8451;</td>
                  </tr>
            ...
            <div className="botm ms-3 d-flex">
              ...
              <div className="bx1 ms-4 d-flex flex-column justify-content-between">
